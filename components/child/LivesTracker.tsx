...
export function LivesTracker({ bankedLives, maxLives, surplus, surplusPerLife }: LivesTrackerProps) {
  ...
  return (
    <div className="flex flex-col items-center rounded-2xl bg-rose-50 px-4 py-2">
      ...
      {atCap ? (
        <span className="text-xs text-rose-700">Lives full!</span>
      ) : (
        <>
          <div className="mt-1 h-1.5 w-20 overflow-hidden rounded-full bg-rose-200">
            <div
